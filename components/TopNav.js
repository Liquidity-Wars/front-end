  ...
  return (
    <>
        ...
        <div className="container flex flex-wrap justify-between items-center mx-auto">
            <div className={` flex ${isWeb3Enabled == true ? "pr-8" : ""} justify-center items-center`}>
            <Link href="/">
            ...
            <div className={`hidden w-full md:block md:w-auto ${isWeb3Enabled == true ? "" : "ml-[-5rem]"}`} id="navbar-default">
